...
public class Tab1 extends FragmentActivity implements ActionBar.TabListener {
	...
	public void onTabSelected(ActionBar.Tab tab,
		...
		{
			ParseQueryAdapter<ParseObject> adapter = new ParseQueryAdapter<ParseObject>(this, "housing");
		...
		{
			ParseQueryAdapter<ParseObject> adapter = new ParseQueryAdapter<ParseObject>(this, "rides");
			adapter.setTextKey("title");
		...
		{
			ParseQueryAdapter<ParseObject> adapter = new ParseQueryAdapter<ParseObject>(this, "events");
			adapter.setTextKey("title");
