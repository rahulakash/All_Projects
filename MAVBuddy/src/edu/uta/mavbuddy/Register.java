...
public class Register extends Activity {
	...
	public void registerSuccess(View view)
	{
		...
		if(validationRegister.isValidUsername(username) && validationRegister.isValidPassword(password, verifyPassword)
				&& validationRegister.isValidEmail(emailId) && validationRegister.isValidVerifyPassword(verifyPassword,password))
		{
	...
	public void registerValidation(){
		...
		username.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				validationRegister.isValidUsername(username);
			}
		});
		...
		password.addTextChangedListener(new TextWatcher() {
			...
			@Override
			public void afterTextChanged(Editable s) {
				validationRegister.isValidPassword(password,verifyPassword);
			}
		});
		...
		verifyPassword.addTextChangedListener(new TextWatcher() {
			...
			@Override
			public void afterTextChanged(Editable s) {
				validationRegister.isValidPassword(verifyPassword,password);
			}
		});
		...
		emailId.addTextChangedListener(new TextWatcher() {
			...
			@Override
			public void afterTextChanged(Editable s) {
				validationRegister.isValidEmail(emailId);
			}
		});
	}
}
