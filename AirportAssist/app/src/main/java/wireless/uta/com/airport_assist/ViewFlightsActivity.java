...
public class ViewFlightsActivity extends ActionBarActivity {
    String flightCarrierNumber,deptGate,deptTerminal;
    Status status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TextView flightLabel= (TextView)findViewById(R.id.flightDeptTxt);
        ...
        OnItemClickListener itemClickListener = new  OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View container, int position, long id) {
                ...
                alertDialogBuilder.setTitle("YOUR FLIGHT DETAILS:  ");

                if(flightArrayList.isEmpty()) {
                    final TextView empty= new TextView(ViewFlightsActivity.this);
                    empty.setText("No flight data available currently");
                    alertDialogBuilder.setView(empty);
                } else {
                    ...
                    final TextView empty2= new TextView(ViewFlightsActivity.this);
                    empty2.setLayoutParams(params);

                    final TextView empty3= new TextView(ViewFlightsActivity.this);
                    empty3.setLayoutParams(params);

                    final TextView empty4= new TextView(ViewFlightsActivity.this);
                    empty4.setLayoutParams(params);
